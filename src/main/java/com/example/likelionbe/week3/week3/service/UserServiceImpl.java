...
import com.example.likelionbe.week3.week3.repository.InMemoryUserRepository;
import com.example.likelionbe.week3.week3.repository.UserRepository;
...
public class UserServiceImpl implements UserService {
	...
	private User createUser(String id, String password) {
		User user = userRepository.findById(id); // null 대신 findUser 에 id 전달해서 User 를 찾아와 대입해보세요.
