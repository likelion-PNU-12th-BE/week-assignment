...
public class UserServiceImpl implements UserService {
	...
	public void saveUser(String id, String password) {
		...
		User user = createUser(id, password); //creatUser에서 user를 받아옴.
	...
	private User createUser(String id, String password) {
		//User user = userRepository.findById(id); //findUser와 같은 부분이므로 재사용성을 위해 밑과 같이 바꾼다. // null 대신 findUser 에 id 전달해서 User 를 찾아와 대입해보세요.
